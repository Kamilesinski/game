...
import sda.com.pl.game.cat.Cat;
...
public class CatController {
    ...
    public CatController() {
        ...
        catList.add(new Cat("Klakier", "Dachowiec", "#000080"));
    }
    ...
    public String getCats(Model model) {
        ...
        return "catsView";
//        mode.addAttribute("breedModel", cat.getRace());
...
//        catList.stream().filter(element -> element.getName().equals(cat.getName())).findFirst();
